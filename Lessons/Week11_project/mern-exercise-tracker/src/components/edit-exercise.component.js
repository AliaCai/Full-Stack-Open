...
//MAKE THIS REFERENCE TO THE RIGHT THING--------------------------------------------------------------------------------
    ...
    componentDidMount(){
        ...
        const arr=window.location.href.split('/');//an array consisting of every step in the url path of our current page
        axios.get('http://localhost:5000/exercises/'+arr[arr.length-1])//doing id directly from url
        .then(response =>{
